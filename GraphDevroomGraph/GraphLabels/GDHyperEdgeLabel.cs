...
namespace org.GraphDevroom.Graph
{
    ...
    /// HyperEdge semantics.
    /// </summary>
    public class GDHyperEdgeLabel : IEquatable<GDHyperEdgeLabel>, IComparable<GDHyperEdgeLabel>, IComparable
    {
        ...
        public GDHyperEdgeLabel(String Name)
        {
            this.Name = Name;
        }
        ...
        public static GDHyperEdgeLabel DEFAULT = new GDHyperEdgeLabel("DEFAULT");
        ...
        public static GDHyperEdgeLabel ParseString(String HyperEdgeLabelAsString)
        {

            return (from _FieldInfo in typeof(GDHyperEdgeLabel).GetFields()
                    let __HyperEdgeLabel = _FieldInfo.GetValue(null) as GDHyperEdgeLabel
        ...
        public static Boolean TryParseString(String HyperEdgeLabelAsString, out GDHyperEdgeLabel HyperEdgeLabel)
        {

            HyperEdgeLabel = (from _FieldInfo in typeof(GDHyperEdgeLabel).GetFields()
                              let __HyperEdgeLabel = _FieldInfo.GetValue(null) as GDHyperEdgeLabel
                              where __HyperEdgeLabel != null
                              where __HyperEdgeLabel.Name == HyperEdgeLabelAsString
                              select __HyperEdgeLabel).FirstOrDefault();
        ...
        public Int32 CompareTo(Object Object)
        {
            ...
            var _HyperEdgeLabel = Object as GDHyperEdgeLabel;
        ...
        /// <returns>true|false</returns>
        public Int32 CompareTo(GDHyperEdgeLabel HyperEdgeLabel)
        {
        ...
        /// <param name="HyperEdgeLabel">An object to compare with.</param>
        /// <returns>true|false</returns>
        public Boolean Equals(GDHyperEdgeLabel HyperEdgeLabel)
        {
