...
namespace org.GraphDevroom.Graph
{
    ...
    /// MultiEdge semantics.
    /// </summary>
    public class GDMultiEdgeLabel : IEquatable<GDMultiEdgeLabel>, IComparable<GDMultiEdgeLabel>, IComparable
    {
        ...
        public GDMultiEdgeLabel(String Name)
        {
            this.Name = Name;
        }
        ...
        public static GDMultiEdgeLabel DEFAULT = new GDMultiEdgeLabel("DEFAULT");
        ...
        public static GDMultiEdgeLabel ParseString(String MultiEdgeLabelAsString)
        {

            return (from _FieldInfo in typeof(GDMultiEdgeLabel).GetFields()
                    let __MultiEdgeLabel = _FieldInfo.GetValue(null) as GDMultiEdgeLabel
        ...
        public static Boolean TryParseString(String MultiEdgeLabelAsString, out GDMultiEdgeLabel MultiEdgeLabel)
        {

            MultiEdgeLabel = (from _FieldInfo in typeof(GDMultiEdgeLabel).GetFields()
                              let __MultiEdgeLabel = _FieldInfo.GetValue(null) as GDMultiEdgeLabel
                              where __MultiEdgeLabel != null
                              where __MultiEdgeLabel.Name == MultiEdgeLabelAsString
                              select __MultiEdgeLabel).FirstOrDefault();
        ...
        public Int32 CompareTo(Object Object)
        {
            ...
            var _MultiEdgeLabel = Object as GDMultiEdgeLabel;
        ...
        /// <returns>true|false</returns>
        public Int32 CompareTo(GDMultiEdgeLabel MultiEdgeLabel)
        {
        ...
        /// <param name="MultiEdgeLabel">An object to compare with.</param>
        /// <returns>true|false</returns>
        public Boolean Equals(GDMultiEdgeLabel MultiEdgeLabel)
        {
